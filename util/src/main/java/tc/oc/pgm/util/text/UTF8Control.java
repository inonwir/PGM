...
/**
 * A {@link java.util.ResourceBundle.Control} implementation which allows reading of .properties
...
final class UTF8Control extends ResourceBundle.Control {
  ...
  public ResourceBundle newBundle(
    ...
    throws IllegalAccessException, InstantiationException, IOException { // Modified Line
    ...
    if (stream != null) {
        try {
            ...
            bundle = new PropertyResourceBundle(new InputStreamReader(stream, "UTF-8")); // Modified Line
        } finally {
            stream.close();
        }
    }
